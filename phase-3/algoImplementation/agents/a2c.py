"""Advantage Actor-Critic for Phase 3 DAG scheduling HNH.

Phase 3 keeps the same NumPy implementation style as phases 1 and 2 while
adapting the representation to the DAG simulator:
  - state_dim = 88 from simulator.state_builder
  - action_dim = 7 for hold durations {0, 15, 30, 60, 120, 180, 300}s
  - wider shared trunk for DAG, resource, SLO, and cluster features
"""
...
class A2CNetwork:
    """Shared-trunk Actor-Critic network for the 88-dim DAG state."""
    ...
    def forward(self, state: np.ndarray):
        ...
        Args:
            state: shape (88,) normalized DAG scheduling state vector
...
class A2CAgent:
    """Advantage Actor-Critic agent for the Phase 3 DAG HNH problem."""
