"""Vanilla online Actor-Critic for Phase 3 DAG scheduling HNH.

Unlike A2C, AC updates every rollout flush without a shared trunk.  It is kept
as a higher-variance comparison agent, matching the structure used in earlier
phases while accepting the Phase 3 88-dimensional state vector.
"""
