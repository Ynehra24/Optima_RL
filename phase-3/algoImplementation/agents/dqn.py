"""Deep Q-Network for Phase 3 DAG scheduling HNH.

The implementation mirrors phases 1 and 2 but uses the 88-dimensional DAG
state and the 7-action second-based hold space.
"""
...
class DQNAgent:
    """Deep Q-Network agent for the 88-dim DAG scheduling state."""
